...
Adaptive Audio Player turns an authorized TXT or DRM-free EPUB into a private, locally generated audiobook. A listener reviews the extracted book, chooses a built-in voice, approves a generated sample, renders the full book, and resumes listening later.
...
3. Review and confirm the extracted title and chapters.
...
- Next.js 16.1.7 and React 19.2.3 serve the local UI and validated API boundary.
...
- PDF, DOCX, scanned document, MP3, or M4B import.
- Original-audio playback or narrator replacement.
- DRM circumvention.
